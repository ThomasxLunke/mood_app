...
export interface LiquidEtherProps {
  ...
  /**
   * RGBA the low-velocity "haze" fades toward, as [r, g, b, a] each 0-1.
   * Defaults to transparent black, which reads as a grey/dark wash on a
   * light background — pass e.g. [1, 1, 1, 0] to fade toward white instead.
   */
...
`
  ...
  return (
    <div
      ref={mountRef}
      className={`w-full h-full relative overflow-hidden pointer-events-none z-50 touch-none ${className || ''}`}
      style={style}
    />
  )
}
