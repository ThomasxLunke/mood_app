...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  const refs = useMemo<CardRef[]>(
    ...
    // Intentionally keyed on count, not identity: refs must stay stable
    // across re-renders as long as the number of cards doesn't change.
  ...
  return (
    <div
      ref={container}
      className="absolute bottom-0 right-0 origin-bottom-right [perspective:900px] max-[480px]:scale-[0.75]"
      style={{ width, height }}
    >
      {rendered}
    </div>
